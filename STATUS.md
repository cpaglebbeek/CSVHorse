...
| SQL query-builder (visuele clauses) | ✓ v0.1.5-Tinker |
...
| **Autosave naar localStorage (throttled 2s, AAN/UIT toggle)** | ✓ **werkend** (v0.2.0-Mustang) |
| **Restore-banner bij page-load met data in storage** | ✓ |
